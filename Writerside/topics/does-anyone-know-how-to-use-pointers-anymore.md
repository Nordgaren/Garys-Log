...
compiler to add an offset when you reference fields further in than the base of the pointer. I am also surprised that MSVC 
didn't catch this? It's perfectly capable of doing so. 
